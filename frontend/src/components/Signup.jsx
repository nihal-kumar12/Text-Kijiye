      ...
      <div className="flex h-screen items-center justify-center">
        ...
        className="border border-black px-6 py-2 rounded-md space-y-3 w-96">
          <h1 className="text-2xl font-semibold text-center">
            Text<span className="text-green-500 font-bold"> Karo</span></h1>
          ...
          <label className="input input-bordered border-black flex items-center gap-2">
            ...
            input {...register("confirmPassword", { required: true, validate:validatePasswordMatch })} />
          </label>
          ...
          <div className="flex justify-between">
            <p>Have an account? <Link to="/login" className="text-blue-500 underline cursor-pointer ml-1">
              Login
              </Link>
            </p>
